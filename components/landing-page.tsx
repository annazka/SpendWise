...
export function LandingPage({ onLaunch }: { onLaunch(): void }) {
  ...
  return <main className="landing-page">
    ...
    <footer className="landing-footer"><a className="landing-logo" href="#top" onClick={(event) => scrollToSection(event, "top")}><Image src="/spendwise-logo.png" alt="" width={30} height={30}/><span><strong>SpendWise</strong><small>Smarter spending. Clearer tomorrow.</small></span></a><nav><a href="#features" onClick={(event) => scrollToSection(event, "features")}>Features</a><a href="#how-it-works" onClick={(event) => scrollToSection(event, "how-it-works")}>How It Works</a><a href="#faqs" onClick={(event) => scrollToSection(event, "faqs")}>FAQs</a></nav><div><a href="https://x.com/SpendWise67" target="_blank" rel="noreferrer" aria-label="SpendWise on X" title="X"><XIcon/></a><a href="https://github.com/annazka/SpendWise" target="_blank" rel="noreferrer" aria-label="SpendWise on GitHub" title="GitHub"><GitHubIcon/></a><a href="https://botchain.ai/" target="_blank" rel="noreferrer" aria-label="BOT Chain" title="BOT Chain"><img src="/bot-chain.png" alt="BOT Chain" width="22" height="22"/></a><a href="https://scan.botchain.ai/" target="_blank" rel="noreferrer" aria-label="BOT Chain Explorer" title="BOT Chain Explorer"><img src="/bot-scan.png" alt="BOT Scan" width="22" height="22"/></a></div></footer>
  </main>;
}
