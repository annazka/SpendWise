...
export function LandingPage({ onLaunch }: { onLaunch(): void }) {
  ...
  return <main className="landing-page">
    ...
    <footer className="landing-footer"><a className="landing-logo" href="#top" onClick={(event) => scrollToSection(event, "top")}><Image src="/spendwise-logo.png" alt="" width={30} height={30}/><span><strong>SpendWise</strong><small>Smarter spending. Clearer tomorrow.</small></span></a><nav><a href="#features" onClick={(event) => scrollToSection(event, "features")}>Features</a><a href="#how-it-works" onClick={(event) => scrollToSection(event, "how-it-works")}>How It Works</a><a href="#faqs" onClick={(event) => scrollToSection(event, "faqs")}>FAQs</a></nav><div><a href="https://x.com/SpendWise67" target="_blank" rel="noreferrer" aria-label="SpendWise on X" title="X"><XIcon/></a><a href="https://github.com/annazka/SpendWise" target="_blank" rel="noreferrer" aria-label="SpendWise on GitHub" title="GitHub"><GitHubIcon/></a><a href="https://botchain.ai/" target="_blank" rel="noreferrer" aria-label="BOT Chain website" title="BOT Chain"><Image src="/bot-chain.png" alt="BOT Chain" width={26} height={26}/></a><a href="https://scan.botchain.ai/address/0x1f04BA244bfDAc7db33061eA88DEE66eD7AFB2Da" target="_blank" rel="noreferrer" aria-label="SpendWise contract on BOT Chain Explorer" title="SpendWise Contract"><Image src="/bot-scan.png" alt="BOT Chain Scan" width={26} height={26}/></a></div></footer>
  </main>;
}
